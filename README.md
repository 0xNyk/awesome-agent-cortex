...
- [SandBase Harness](https://github.com/sandbaseai/sandbase-harness) - Local-first agent runtime with sandboxed sessions, MCP tools, memory, credentials, audit, and replay across local and self-hosted backends.
