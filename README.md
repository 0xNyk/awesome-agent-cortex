...
- [FDE Lessons API](https://api.ignatiustheyoungerai.com) - Pay-per-query engineering rules and AI product pricing data over Stripe MPP, with free preview endpoints and an MCP server.
